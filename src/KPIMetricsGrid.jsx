    ...
    <div className="space-y-6">
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
        {metrics.map((metric) => (
          <div
            key={metric.title}
            className={`group bg-slate-950/40 backdrop-blur-md rounded-2xl border border-slate-800 p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-950/20 bg-gradient-to-br ${metric.color} ${metric.borderColor}`}
          >
        ...
        <div className="group bg-slate-950/40 backdrop-blur-md rounded-2xl border border-slate-800 p-6 flex flex-col justify-between transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-950/20 bg-gradient-to-br from-indigo-500/20 to-blue-500/5 hover:border-indigo-500/50 col-span-1 sm:col-span-2 lg:col-span-3">
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-6">
            ...
            <div className="p-3.5 rounded-xl bg-indigo-500/10 text-indigo-400 transition-transform duration-300 group-hover:scale-110 self-start sm:self-center">
              <svg className="w-6 h-6" fill="none" viewBox="0 0 24 24" stroke="currentColor">
